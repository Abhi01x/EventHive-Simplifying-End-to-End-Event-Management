  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.success === true || data.message === "signup success") {
        ...
        setError(data.message || data.msg || data.error || "Registration failed")
      }
    } catch (error) {
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <span className="text-2xl font-bold">EventHive</span>
          </div>
        ...
        <Card>
          <CardHeader className="text-center">
            ...
            <CardDescription>Start your journey with EventHive</CardDescription>
          </CardHeader>
          <CardContent>
